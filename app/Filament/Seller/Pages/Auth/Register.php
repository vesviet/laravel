 ...
 *
 * ADR-S2: Transaction boundary is owned here (the caller Action layer equivalent).
...
class Register extends BaseRegister
{
    ...
    /**
     * Handle the full registration within a single DB transaction.
     *
     ...
     *
     * Note: RegisterSellerAction opens its own nested transaction (via DB::transaction).
