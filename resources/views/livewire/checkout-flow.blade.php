                ...
                @foreach($steps as $index => $step)
                    ...
                    <div class="flex flex-col items-center relative">
                        ...
                        @if($index < count($steps) - 1)
                            <div class="absolute top-4 left-1/2 w-full h-1 bg-border-subtle z-0"
                                :class="{ 'bg-badge-hot': @json($isCompleted) }"></div>
                        @endif

                        {{-- Circle --}}
                        <div class="relative z-10 w-8 h-8 rounded-full flex items-center justify-center
                            {{ $isActive
                                ? "bg-badge-hot text-white border-2 border-badge-hot"
                                : ($isCompleted ? "bg-badge-hot text-white" : "bg-white text-muted-text border-2 border-border-subtle") }}"
                        >
                            @if($isCompleted)
                        ...
                        <span class="mt-2 text-[10px] uppercase tracking-wider font-medium
                            {{ $isActive ? "text-badge-hot" : ($isCompleted ? "text-badge-hot" : "text-muted-text") }}">
                            {{ $stepLabels[$step] }}
                        </span>
                    </div>
                @endforeach
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                                    ...
                                    <div class="md:col-span-1">
                                        ...
                                        <input type="text"
                                               ...
                                               required
                                               autocomplete="name"
                                               class="input-underline w-full @error('shippingData.customer_name') border-badge-hot @enderror"
                                               aria-required="true">
                                    ...
                                    <div class="md:col-span-1">
                                        ...
                                        <input type="tel"
                                               ...
                                               required
                                               autocomplete="tel"
                                               class="input-underline w-full @error('shippingData.phone') border-badge-hot @enderror"
                                               aria-required="true">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="email"
                                               ...
                                               id="email"
                                               autocomplete="email"
                                               class="input-underline w-full @error('shippingData.email') border-badge-hot @enderror">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="text"
                                               ...
                                               class="input-underline w-full @error('shippingData.address') border-badge-hot @enderror"
                                               aria-required="true">
                                    ...
                                    <div>
                                        ...
                                        <input type="text"
                                               ...
                                               class="input-underline w-full @error('shippingData.district') border-badge-hot @enderror">
                                    ...
                                    <div>
                                        ...
                                        <input type="text"
                                               ...
                                               id="ward"
                                               class="input-underline w-full @error('shippingData.ward') border-badge-hot @enderror">
                            ...
                            <div>
                                ...
                                <div class="flex justify-end pt-4">
                                    <button type="button"
                                            ...
                                            class="mr-4 px-4 py-2 text-xs uppercase tracking-wider text-muted-text hover:text-badge-hot font-medium link-underline">
                                        Quay lại
                                    </button>
                                    <button type="submit"
                                            :disabled="isProcessing"
                        ...
                        <form wire:submit.prevent="submitOrder" class="space-y-8" @submit.prevent="return false">
                            ...
                            <div>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="bg-white border border-border-subtle p-4 rounded-lg">
                                        <h3 class="text-xs font-semibold tracking-[0.15em] uppercase text-primary-dark mb-3">Thông tin giao hàng</h3>
                                        <div class="grid grid-cols-2 gap-2 text-sm">
                                            <div>
                                                <span class="text-muted-text">Họ và tên</span>
                                                <p class="font-medium" x-text="shippingData.customer_name"></p>
                                            </div>
                                            <div>
                                                <span class="text-muted-text">Điện thoại</span>
                                                <p class="font-medium" x-text="shippingData.phone"></p>
                                            </div>
                                            <div class="col-span-2">
                                                <span class="text-muted-text">Địa chỉ</span>
                                                <p class="font-medium" x-text="shippingData.address + ', ' + shippingData.ward + ', ' + shippingData.district + ', ' + shippingData.city"></p>
                                            </div>
                                            <div class="col-span-2">
                                                <span class="text-muted-text">Ghi chú</span>
