<div class="mt-12 bg-white p-6 rounded-lg shadow-sm border border-gray-100">
    ...
    @error('purchase_required')
        <div class="bg-amber-50 border border-amber-200 text-amber-800 p-4 rounded-md mb-6 text-sm flex items-center gap-2" role="alert">
    ...
    @error('duplicate_review')
        <div class="bg-blue-50 border border-blue-200 text-blue-800 p-4 rounded-md mb-6 text-sm flex items-center gap-2" role="alert">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-blue-600 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
