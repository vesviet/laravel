    ...
    <div class="border-t border-border-subtle pt-5 space-y-3">
        ...
        <template x-if="showPromotions && breakdown.appliedRules && breakdown.appliedRules.length > 0">
            <div class="py-2 border-t border-dashed border-border-subtle space-y-2">
                <span class="text-[10px] font-semibold text-muted-text uppercase tracking-wider block">\u01a0u \u0111\u00e3i \u00e1p d\u1ee5ng</span>
        ...
        <div class="flex justify-between pt-4 border-t border-border-subtle items-baseline">
            ...
            <span class="text-xl font-bold text-badge-hot" x-text="fmt(breakdown.finalTotal)"></span>
        </div>
    </div>
