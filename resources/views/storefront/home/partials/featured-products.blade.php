...
<section class="py-12 md:py-16">
    <div class="section-wrapper">
        ...
        <div class="section-header flex items-end justify-between mb-8 pb-3 border-b border-[#E5E5E5]/60">
            <div>
                <span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-[#888888] block mb-1">Featured Collection</span>
                <h2 class="section-title text-2xl md:text-3xl font-medium tracking-wide text-[#23232C]">Sản Phẩm Nổi Bật</h2>
            </div>
        ...
        <hr class="border-t border-[#E5E5E5] mt-16">
