...
<section class="py-12 md:py-16">
    <div class="section-wrapper">
        ...
        <div class="section-header flex items-end justify-between mb-8 pb-3 border-b border-border-subtle/60">
            <div>
                <span class="text-[10px] font-semibold tracking-[0.2em] uppercase text-muted-text block mb-1">New Trend</span>
                <h2 class="section-title text-2xl md:text-3xl font-medium tracking-wide text-primary-dark">Sản Phẩm Mới</h2>
            </div>
        ...
        @if($products->isEmpty())
            <p class="text-sm text-muted-text text-center py-12">Chưa có sản phẩm nào.</p>
        @else
