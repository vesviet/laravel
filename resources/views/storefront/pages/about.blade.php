...
<div class="py-16 md:py-24">
    <div class="section-wrapper max-w-4xl mx-auto">
        ...
        <p class="text-sm md:text-base text-[#888888] text-center leading-relaxed font-light mb-12 max-w-2xl mx-auto">
            Chúng tôi tin rằng không gian sống đẹp và tối giản mang lại sự bình yên và nguồn cảm hứng sáng tạo mỗi ngày.
        </p>

        <div class="space-y-12 text-[#23232C] font-light leading-relaxed">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6">
                <div>
                    <h2 class="text-lg font-medium tracking-wide uppercase mb-3 text-[#23232C]">Triết Lý Thiết Kế</h2>
                ...
                <div>
                    <h2 class="text-lg font-medium tracking-wide uppercase mb-3 text-[#23232C]">Cam Kết Chất Lượng</h2>
                    <p class="text-sm text-[#888888] leading-relaxed">
