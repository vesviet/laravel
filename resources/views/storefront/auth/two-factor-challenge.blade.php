    ...
    <div class="section-wrapper">
        <div class="max-w-sm mx-auto">
            ...
            <form method="POST" action="{{ route("account.2fa.verify") }}" class="space-y-6">
                ...
                {{-- TOTP Code --}}
                <div>
                    <label for="code" class="block text-[10px] tracking-[0.15em] uppercase text-[#888888] mb-2">
                        Mã xác thực 6 chữ số <span class="text-[#E84444]">*</span>
                    </label>
                    <input type="text"
                           name="code"
                           id="code"
                           ...
                           class="input-underline w-full text-center tracking-widest text-xl @error("code") border-[#E84444] @enderror">
                    @error("code")
                ...
                <div class="pt-2 border-t border-[#E5E5E5]">
                    <p class="text-xs text-[#888888] font-light text-center mb-4">
                        Hoặc sử dụng mã khôi phục
                    </p>
                    <div>
                        <label for="recovery_code" class="block text-[10px] tracking-[0.15em] uppercase text-[#888888] mb-2">
