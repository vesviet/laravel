    ...
    <div class="section-wrapper">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-2xl font-light text-[#23232C] tracking-wide uppercase">Cài Đặt Thông Báo</h1>
            ...
            <form method="POST" action="{{ route("account.notifications.update") }}" class="space-y-6">
                ...
                <div class="bg-white border border-[#E5E5E5] p-6 shadow-sm">
                    <h3 class="text-xs font-semibold tracking-[0.2em] uppercase text-[#23232C] mb-6 pb-3 border-b border-[#E5E5E5] flex items-center gap-2">
                        <svg class="w-5 h-5 text-[#23232C]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <div class="space-y-4 mt-4">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <label for="order_updates" class="text-sm font-medium text-[#23232C] cursor-pointer">Cập nhật đơn hàng</label>
                                    <p class="text-xs text-[#888888] font-light">Xác nhận đơn hàng, vận chuyển, giao hàng thành công</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <label for="promotions" class="text-sm font-medium text-[#23232C] cursor-pointer">Khuyến mãi & Ưu đãi</label>
                                    <p class="text-xs text-[#888888] font-light">Mã giảm giá, flash sale, sản phẩm mới</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between opacity-75">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <label for="security_alerts" class="text-sm font-medium text-[#23232C] cursor-pointer">Cảnh báo bảo mật</label>
                                    <p class="text-xs text-[#888888] font-light">Đăng nhập mới, đổi mật khẩu, bật/tắt 2FA (không thể tắt)</p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <label for="newsletter" class="text-sm font-medium text-[#23232C] cursor-pointer">Bản tin (Newsletter)</label>
                                    <p class="text-xs text-[#888888] font-light">Thông tin sản phẩm mới, bài viết blog, tips nội thất</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white border border-[#E5E5E5] p-6 shadow-sm">
                    ...
                    <div class="space-y-4 mt-4">
                        <p class="text-xs text-[#888888] font-light mb-4">Cần số điện thoại đã xác thực. Phí SMS áp dụng theo nhà mạng.</p>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <label for="sms_order_updates" class="text-sm font-medium text-[#23232C] cursor-pointer">Cập nhật đơn hàng qua SMS</label>
                                    <p class="text-xs text-[#888888] font-light">Xác nhận đơn hàng, mã OTP giao hàng, giao thành công</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <label for="sms_promotions" class="text-sm font-medium text-[#23232C] cursor-pointer">Khuyến mãi qua SMS</label>
                                    <p class="text-xs text-[#888888] font-light">Mã giảm giá, flash sale thông qua tin nhắn</p>
                                </div>
                            </div>
                        </div>
                    </div>
